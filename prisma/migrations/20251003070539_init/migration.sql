...
-- CreateTable
CREATE TABLE "public"."ProjectMemeber" (
    "id" SERIAL NOT NULL,
    ...
    CONSTRAINT "ProjectMemeber_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectMemeber_userId_projectId_key" ON "public"."ProjectMemeber"("userId", "projectId");
...
-- AddForeignKey
ALTER TABLE "public"."ProjectMemeber" ADD CONSTRAINT "ProjectMemeber_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."ProjectMemeber" ADD CONSTRAINT "ProjectMemeber_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "public"."Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "public"."Comments" ADD CONSTRAINT "Comments_issueId_fkey" FOREIGN KEY ("issueId") REFERENCES "public"."Task"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Comments" ADD CONSTRAINT "Comments_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
